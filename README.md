...
- [中文版](#中文版)
  - [目录结构与依赖数据](#目录结构与依赖数据)
  - [运行方式与参数开关](#运行方式与参数开关)
  - [最终方案特征工程改进总览](#最终方案特征工程改进总览)
  - [追踪数据清洗与像素归一化](#1-追踪数据清洗与像素归一化)
  - [元属性编码与 Meta 特征拼接](#2-元属性编码与-meta-特征拼接)
  - [第三只小鼠上下文特征（三体关系）](#3-第三只小鼠上下文特征三体关系)
  - [单鼠高级运动模式（长区间--未来过去对比）](#4-单鼠高级运动模式长区间--未来过去对比)
  - [双鼠互动拓展--上下文比值](#5-双鼠互动拓展--上下文比值)
  - [训练推理阶段特征一致性与异常监控](#6-训练推理阶段特征一致性与异常监控)
  - [自适应阈值寻优与推理策略](#7-自适应阈值寻优与推理策略)
